...
CREATE TABLE public.transmissions (
    ...
    channel_label character varying NOT NULL,
...
CREATE INDEX index_transmissions_on_channel_label_and_started_at ON public.transmissions USING btree (channel_label, started_at);
...
CREATE UNIQUE INDEX index_transmissions_on_object_key ON public.transmissions USING btree (object_key);


--
-- Name: index_transmissions_on_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_transmissions_on_status ON public.transmissions USING btree (status);
